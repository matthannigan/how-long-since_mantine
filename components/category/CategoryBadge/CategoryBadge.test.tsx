...
describe('CategoryBadge', () => {
  it('renders category name', () => {
    renderWithProviders(<CategoryBadge category={mockCategory} />);

    expect(screen.getByText('Test Category')).toBeInTheDocument();
  });

  it('renders with icon when showIcon is true', () => {
    renderWithProviders(<CategoryBadge category={mockCategory} showIcon />);
  ...
  it('renders without icon when showIcon is false', () => {
    renderWithProviders(<CategoryBadge category={mockCategory} showIcon={false} />);
  ...
  it('renders without icon when category has no icon', () => {
    ...
    renderWithProviders(<CategoryBadge category={categoryWithoutIcon} />);

    expect(screen.getByText('Test Category')).toBeInTheDocument();
  });

  it('applies correct size prop', () => {
    renderWithProviders(<CategoryBadge category={mockCategory} size="lg" />);
  ...
  it('applies correct variant prop', () => {
    renderWithProviders(<CategoryBadge category={mockCategory} variant="filled" />);
  ...
  it('handles invalid icon names gracefully', () => {
    ...
    renderWithProviders(<CategoryBadge category={categoryWithInvalidIcon} />);
  ...
  it('applies custom color styling', () => {
    ...
    renderWithProviders(<CategoryBadge category={customColorCategory} />);
